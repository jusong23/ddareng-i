...
//MARK: - OpenWeather : 실시간 날씨 데이터
    func getCurrentWeather(onCompleted: @escaping (Swift.Result<WeatherInfo,Error>)-> Void) {
        let url = "https://api.openweathermap.org/data/2.5/onecall?lat=37.6215&lon=127.0598&exclude=hourly&appid=70712209ed38b3c9995cdcdd87bda250&units=metric"
        AF.request(url,
